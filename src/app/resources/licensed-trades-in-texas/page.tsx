...
export default function LicensedTradesPage() {
  const pageUrl = `${SITE_URL}/resources/licensed-trades-in-texas`;
          ...
          __html: JSON.stringify(
            graph([
              ...
              breadcrumbNode(pageUrl, [
                ...
                { name: "Licensed Trades in Texas", path: "/resources/licensed-trades-in-texas" },
              ]),
              articleNode({
                url: pageUrl,
                headline: "What Licensed Trades Require in Texas",
                description:
                  "An overview of which trades require state licensing in Texas, including plumbing, electrical, HVAC, and irrigation. What property owners and subcontractors need to know.",
